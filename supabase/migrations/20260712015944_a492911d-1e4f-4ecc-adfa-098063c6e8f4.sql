...
BEGIN
  ...
  VALUES (post_id, uid, 'https://selftest.local/x.jpg', 'overall', 1080, 1080,
  ...
  VALUES (uid, post_id, 'city', 'Selftest', 'overall', 'Selftest Crown', 100, true);
  ...
  -- Impersonate: use_royal_shield reads auth.uid() → request.jwt.claim.sub.
  ...
  SELECT * INTO boost_row FROM public.boosts b
    WHERE b.post_id = royal_wave82a_shield_selftest.post_id AND boost_type='crown_shield'
