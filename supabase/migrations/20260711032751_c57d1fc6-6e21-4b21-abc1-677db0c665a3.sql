...
BEGIN
  ...
  SELECT slug INTO v_main FROM public.main_categories LIMIT 1;
  SELECT slug INTO v_sub FROM public.subcategories LIMIT 1;
  ...
  VALUES (test_user, 25, 'image', 1080, 1080, v_main, v_sub)
