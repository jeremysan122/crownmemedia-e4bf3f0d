...
const BattlesHistory = lazy(() => import("./pages/BattlesHistory"));
...
const CommandCenterLiveBattleReports = lazy(() => import("./pages/admin/CommandCenterLiveBattleReports"));
        ...
        <AuthProvider>
          ...
          <Suspense fallback={<RouteFallback />}>
            ...
            <Routes>
              ...
              <Route path="/battles/history" element={<ProtectedRoute><BattlesHistory /></ProtectedRoute>} />
              ...
              <Route path="/admin/command-center" element={<ProtectedRoute><AdminRoute><CommandCenterLayout /></AdminRoute></ProtectedRoute>}>
                ...
                <Route path="achievement-author" element={<CommandCenterAchievementAuthor />} />
              </Route>
