...
export default function CsaePolicy() {
  return (
    <LegalShell title="Child Safety & CSAE Standards" effectiveDate="May 2, 2026" lastUpdated="July 4, 2026" version="1.2">
      <P>
        CrownMe Media, has zero tolerance for child sexual
        abuse and exploitation ("CSAE"). This document describes our standards in
        compliance with the Google Play CSAE Standards and Apple App Store guidelines, and
        explains how we prevent, detect, respond to, and report CSAE on our Service.
      </P>

      <H2>1. Scope</H2>
      <P>
        CrownMe Media is strictly an 18+ platform. We prohibit minors from creating or using
        accounts and prohibit any sexual content involving minors anywhere on the Service,
        including profiles, posts, comments, direct messages, gifts, usernames, and
        bios.
      </P>
      ...
      <UL>
        ...
        <li>Keyword and behavioral signals in messages and posts trigger human review.</li>
        <li>Rate limits, friction on new accounts, and pattern detection for grooming behavior.</li>
        <li>Restrictions on direct messaging until trust signals are met.</li>
      </UL>

      <H2>5. Reporting</H2>
      <P>
        Every post, comment, message, and profile has an in-app Report button with a
        dedicated "Child safety" category. Reports are routed immediately to our priority
        safety queue for human review.
      </P>
      <P>
        You may also email{" "}
      ...
      <UL>
        <li>Confirmed CSAM is preserved as required and reported to the U.S. National Center for Missing & Exploited Children (NCMEC) CyberTipline, and to law enforcement and analogous authorities in other jurisdictions where required.</li>
      ...
      <P>
        Child-safety lead: <a className="underline text-primary" href="mailto:support@crownmemedia.com">support@crownmemedia.com</a>{" "}
        (subject: "CSAE Contact"). For law enforcement, use subject "Law Enforcement Request."
      </P>
